...
public:
    ...
    // Optional instruction-entry oracle used by NDS4MiSTer's FPGA lockstep
    // harness. Enabled only when NDS4MISTER_ARM_TRACE is set.
    void TraceInstructionEntry();
    void TraceBus(const char* kind, u32 addr, u32 size, u32 value);
    ...
    std::FILE* LockstepTraceFile;
    u64 LockstepTraceSequence;
    u64 LockstepTraceLimit;
    bool LockstepTraceBusOnly;
    bool LockstepTraceHpsOnly;
    bool LockstepTraceLowPcOnly;
    bool LockstepTraceIrqFocus;
    bool LockstepTracePcRange;
    u32 LockstepTracePcMin;
    u32 LockstepTracePcMax;
    bool LockstepTraceTriggerEnabled;
    bool LockstepTraceTriggered;
    u32 LockstepTraceTriggerPc;
