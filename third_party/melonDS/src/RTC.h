...
public:
    ...
    // NDS4MiSTer offline fast-beta mode.  The serial register remains
    // available, but wall-clock advancement and RTC IRQ production stop for
    // the lifetime of this NDS instance.
    void EnableOfflineStub();
    bool OfflineStubEnabled() const { return OfflineStub; }
