...
public:
    ...
    ~Wifi();
    void Reset();
    // Default-off NDS4MiSTer fast-beta stub.  Once enabled, WiFi MMIO is
    // inert/open-zero and no WiFi timer or IRQ can be produced until a new
    // NDS instance is constructed.
