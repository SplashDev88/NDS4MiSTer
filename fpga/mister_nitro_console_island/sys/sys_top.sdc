...
# These OSD counters and their immediate decode state only advance under
# ce_pix. At the 148.5 MHz timing corner ce_pix is separated by multiple HDMI
# clocks; lower-resolution modes use a proportionally slower HDMI PLL. The
# original one-cycle constraints therefore described cycles in which these
# registers cannot capture and produced false HDMI-domain violations.
set_multicycle_path -to {*_osd|h_cnt* *_osd|osd_hcnt* *_osd|osd_div* *_osd|osd_de*} -setup 2
set_multicycle_path -to {*_osd|h_cnt* *_osd|osd_hcnt* *_osd|osd_div* *_osd|osd_de*} -hold 1
