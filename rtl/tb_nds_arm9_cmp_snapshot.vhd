...
entity tb_nds_arm9_cmp_snapshot is
end entity;

architecture sim of tb_nds_arm9_cmp_snapshot is
...
begin
   ...
   boot : entity work.nds_cpu_boot_sequencer
      port map (
         ...
         arm9_entry => x"020694FC", arm7_entry => x"00001000",
   ...
   begin
      ...
      wait until debug_execute(31 downto 28) = x"D" for 20 us;
      assert debug_execute = x"D0070000"
         report "CMP snapshot did not preserve NZCV/R2/R1/R0: " &
                to_hstring(debug_execute)
         severity failure;
      report "PASS: ARM9 first-divergence CMP snapshot preserves operands"
         severity note;
      stop;
      wait;
   end process;
